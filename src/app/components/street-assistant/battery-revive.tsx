...
import { ChevronLeft, CreditCard, Wallet, Smartphone, CheckCircle2, Clock, Star, Battery as BatteryIcon, MapPin } from 'lucide-react';
...
export function BatteryRevive() {
  ...
  const providers = streetAssistantProviders['battery-revive'];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F2F5FB] via-white to-[#FEFBF3] pb-24">
      ...
      <div className="bg-gradient-to-r from-[#2952AB] to-[#3B6EC9] px-4 pt-12 pb-6">
        <div className="max-w-md mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="font-medium text-white">Battery Revive</h1>
              <p className="text-sm text-white/80">Jump start your vehicle</p>
            </div>
          </div>
      ...
      <div className="max-w-md mx-auto px-4 mt-6 space-y-6">
          ...
          <>
            ...
            <div className="bg-gradient-to-r from-[#FEF8E7] to-[#E4ECF7] rounded-[10px] p-4 border border-[#C69815]/20">
              <p className="text-sm text-[#2952AB]">
                <strong>Quick Service:</strong> Our technicians will arrive with professional equipment to safely jump start your battery.
              </p>
            </div>
          </>
        )}
        ...
        {step === 'provider' && (
          <div>
            <h3 className="text-sm font-medium text-[#2952AB] mb-3">Available Technicians</h3>
                ...
                >
                  <div className="flex items-start gap-3 mb-3">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#2952AB]/10 to-[#C69815]/10 rounded-full flex items-center justify-center flex-shrink-0">
                      <BatteryIcon size={20} className="text-[#2952AB]" strokeWidth={1.5} />
                    </div>
        ...
        <div className="fixed bottom-20 left-0 right-0 bg-gradient-to-t from-white via-white to-transparent px-4 pt-4 pb-4">
          <div className="max-w-md mx-auto">
            ...
            >
              ...
              {step === 'provider' && 'Request Jump Start'}
            </button>
          </div>
        </div>
      )}
