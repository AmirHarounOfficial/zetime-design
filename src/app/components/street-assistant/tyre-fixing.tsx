...
import { ChevronLeft, CreditCard, Wallet, Smartphone, CheckCircle2, Clock, Star, Settings, MapPin } from 'lucide-react';
...
export function TyreFixing() {
  ...
  const providers = streetAssistantProviders['tyre-fixing'];
      ...
      <div className="bg-gradient-to-r from-[#2952AB] to-[#3B6EC9] px-4 pt-12 pb-6">
        <div className="max-w-md mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="font-medium text-white">Tyre Fixing</h1>
              <p className="text-sm text-white/80">Emergency tire repair service</p>
            </div>
          </div>
          ...
          <>
            ...
            <div className="bg-gradient-to-r from-[#FEF8E7] to-[#E4ECF7] rounded-[10px] p-4 border border-[#C69815]/20">
              <p className="text-sm text-[#2952AB] mb-2">
                <strong>Pricing Upon Inspection:</strong> The technician will assess the tire damage and provide a quote before starting repairs.
              </p>
              <p className="text-xs text-[#2952AB]/70">
                Common services: flat tire repair, tire replacement, puncture patching
              </p>
            </div>
          </>
        )}
                ...
                >
                  <div className="flex items-start gap-3 mb-3">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#2952AB]/10 to-[#C69815]/10 rounded-full flex items-center justify-center flex-shrink-0">
                      <Settings size={20} className="text-[#2952AB]" strokeWidth={1.5} />
                    </div>
        ...
        <div className="fixed bottom-20 left-0 right-0 bg-gradient-to-t from-white via-white to-transparent px-4 pt-4 pb-4">
          <div className="max-w-md mx-auto">
            ...
            >
              ...
              {step === 'provider' && 'Request Tire Service'}
            </button>
          </div>
        </div>
      )}
